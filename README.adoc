...
link:https://github.com/grafikrobot/cpp_scope/blob/main/wg21_letter.adoc[Read Letter]
...
link:https://github.com/grafikrobot/cpp_scope/blob/main/incits_letter.adoc[Read Letter]
